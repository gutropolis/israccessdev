...
function resetAuditoriumDigitalMap(){
	var url = $('iframe').attr('src');


	//reload the iframe to launch new .loadMap() defined in bundle.js (call of event eventJsonMap who load the map json structures)
	$('iframe').attr('src', url);
}


function SaveToAuditorium(event){

	var auditorium = $('#auditoriumselect').val();

	$.ajax({
		url : '/admin/syncfromevent',
		type: 'POST',
		data : {'aud_id' : auditorium ,'event_id' : event},
