            ...
            },
			{
            ...
            },
			 {
                ...
                template: function(t, e, a) {
					var edit_lnk = '';
					var del_lnk = '';
					var edit_link = '\t\t\t\t\t\t<a href="javascript:void(0);" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit Community" onclick="edit('+[t.id]+')">\t\t\t\t\t\t\t<i class="la la-edit"></i>\t\t\t\t\t\t</a>';
					var del_link = '\t\t\t\t\t\t<a href="javascript:void(0);" onclick="delete_function('+[t.id]+')" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete Community">\t\t\t\t\t\t\t<i class="la la-trash"></i>\t\t\t\t\t\t</a>\t\t\t\t\t';
					if(IS_COMMUNITY_EDIT == 'Y'){
					   var edit_lnk = edit_link;
					}
					if(IS_COMMUNITY_DEL == 'Y'){
...
jQuery(document).ready(function() {
    if(IS_COMMUNITY_ADD == 'Y' || IS_COMMUNITY_EDIT == 'Y' || IS_COMMUNITY_DEL == 'Y'){
