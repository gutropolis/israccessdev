            ...
            },
			{
            ...
            },
			 {
                ...
                template: function(t, e, a) {
					var edit_lnk = '';
					var del_lnk = '';
					var edit_link = '\t\t\t\t\t\t<a href="javascript:void(0);" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit Payment Type" onclick="edit('+[t.id]+')">\t\t\t\t\t\t\t<i class="la la-edit"></i>\t\t\t\t\t\t</a>';
					var del_link = '\t\t\t\t\t\t<a href="javascript:void(0);" onclick="delete_function('+[t.id]+')" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete Payment Type">\t\t\t\t\t\t\t<i class="la la-trash"></i>\t\t\t\t\t\t</a>\t\t\t\t\t';
					if(IS_PAYMENT_TYPE_EDIT == 'Y'){
						var edit_lnk = edit_link;
					}
					if(IS_PAYMENT_TYPE_DEL == 'Y'){
...
jQuery(document).ready(function() {
  if(IS_PAYMENT_TYPE_ADD == 'Y' || IS_PAYMENT_TYPE_EDIT == 'Y' || IS_PAYMENT_TYPE_DEL == 'Y'){	  
