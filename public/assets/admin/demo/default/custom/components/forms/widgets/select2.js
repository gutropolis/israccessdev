...
jQuery(document).ready(function(){
  ...
  $("#m_select2_3,#m_select2_3_edit").select2({
    placeholder: "Select city",
    allowClear: true
});	
$("#m_select2_4,#m_select2_4_edit").select2({
...
$("#m_select2_event_dashboard").select2({
    placeholder: "Select an Event"/*,
    allowClear: true*/
});

$("#m_select1_event_dashboard").select2({
...
$("#m_select2_21_validate").select2({
    placeholder: "Select Children",
    //allowClear: true
});

$("#m_select2_22_validate").select2({
    placeholder: "Select Children"/*,
    allowClear: true*/
});	
