			...
			if($countT >0){
			 ...
			 $bodyCar .=' <div class="carttable">';
														...
														<div class="cartItem">
													     ...
													     <div class="cartlefu">
															...
															<div class="cartnbre">
																<h2>Nbre de places </h2>
																<div class="evencon">
																<p>Row '.$cartItem['ticket_row'].' - '.$cartItem['qtx'].' places</p>
																</div>
															</div>
															<div class="cartcat">
																<h2>Categorie</h2>
				...
				$bodyCar .=' <div role="tabpanel" class="tab-pane fade active show" id="Confirmation">
								...
								<a href="/"  ><h5>  CONTINUEZ VOTRE VISTE </h5></a>
													...
													$eventSt .= 					'</td></tr></table></td>
																		...
																		<td style="padding-left: 25px; font-family:  \'Roboto Condensed\', sans-serif; width: 20%" width="20%">
																			...
																			<table width="100%" cellspacing="0" cellpadding="0"  border="0" style="border-collapse: collapse">
																				...
																				<tr><td style="padding: 5px 0 10px; text-align: center; font-family:  \'Roboto Condensed\', sans-serif;"  >'.$seat_display_number.'</td></tr></table>
																	...
																	if($ticketType == '1'){
																		$message =  file_get_contents(ROOT_PATH.'/pdf/free_placement.html');  //Free Placement Ticket
																	}else{
				...
				if(count($orderData) > 0){
						 foreach($orderData as $array_data){
										...
										if(count($ticketSeatArr)){
										   ...
										   $subject ='Confirmation de votre commande CulturAccess';
										   //echo $pdfContent;exit;
										   downloadOrderPDF($msgArra,$pdfContent);
