...
class AdminMemberController extends Base 
{
  ...
  public function saveMember($request, $response){
	...
	// downloadMembersCSV
	public function downloadMembersCSV($request, $response, $args){
			...
			$reportTableTitle = 	'<h1><center> List of Members '.date('d/m/Y').'</center></h1>';
			$reportTable = '';
			$reportTable .= '<table border="1" >
						  <thead>
						  <tr>
						  <th colspan="12" style="background-color:#fff2cb; color:#000">'.$reportTableTitle.'</th>
						  </tr>
							<tr>
							  <th style="'.$thStyle.'"><h3>#</h3></th>
							  <th style="'.$thStyle.'"><h3>'.$this->lang['member_last_name_txt'].'</h3></th>
							  <th style="'.$thStyle.'"><h3>'.$this->lang['member_name_label_txt'].'</h3></th>
							  <th style="'.$thStyle.'"><h3>'.$this->lang['member_email_label_txt'].'</h3></th>
							  <th style="'.$thStyle.'"><h3>'.$this->lang['member_address_1_txt'].'</h3></th>
							  <th style="'.$thStyle.'"><h3>'.$this->lang['member_address_2_txt'].'</h3></th>
							  <th style="'.$thStyle.'"><h3>'.$this->lang['member_street_txt'].'</h3></th>
							  <th style="'.$thStyle.'"><h3>'.$this->lang['member_postal_code_txt'].'</h3></th>
							  <th style="'.$thStyle.'"><h3>'.$this->lang['member_phone_no_txt'].'</h3></th>
							  <th style="'.$thStyle.'"><h3>'.$this->lang['member_dob_txt'].'</h3></th>
							  <th style="'.$thStyle.'"><h3>'.$this->lang['member_country_txt'].'</h3></th>
							  <th style="'.$thStyle.'"><h3>'.$this->lang['member_ville_txt'].'</h3></th>
							</tr>
						  </thead>
						  <tbody>';	
				$sqlReport = "SELECT 
							  ...
							  U.name,
							  U.email,
							  DATE_FORMAT(U.registration_date, '%d/%M/%Y') AS registered_date,
							  UM.first_name,
							  UM.last_name,
							  UM.address_1,
							  UM.address_2,
							  ...
							  UM.postal_code,
							  UM.phone_no,
							  DATE_FORMAT(UM.dob, '%d/%M/%Y') AS date_of_birth,
							  UM.country,
							  UM.ville 
							FROM
							  `users` AS U 
			...
			while($row = mysqli_fetch_assoc($resultQuery)){
				...
				$reportTable .= '<tr>
									  ...
									  <td style="'.$style.'">'.$row['last_name'].'</td>
									  <td style="'.$style.'">'.$row['name'].'</td>
									  <td style="'.$style.'">'.$row['email'].'</td>
									  <td style="'.$style.'">'.$row['address_1'].'</td>
									  <td style="'.$style.'">'.$row['address_2'].'</td>
									  <td style="'.$style.'">'.$row['street'].'</td>
									  <td style="'.$style.'">'.$row['postal_code'].'</td>
									  <td style="'.$style.'">'.$row['phone_no'].'</td>
									  <td style="'.$style.'">'.$row['date_of_birth'].'</td>
									  <td style="'.$style.'">'.$row['country'].'</td>
									  <td style="'.$style.'">'.$row['ville'].'</td>
								</tr>'; 	 	
			$counter++;
			}
